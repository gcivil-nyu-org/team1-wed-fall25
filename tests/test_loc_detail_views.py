...
class LocDetailIndexViewTests(TestCase):
    ...
    def test_index_search_by_artist(self):
        ...
        self.client.login(username='testuser', password='testpass123')
        response = self.client.get(reverse('loc_detail:index'), {'search': 'Artist One'})
    ...
    def test_index_search_by_location(self):
        ...
        self.client.login(username='testuser', password='testpass123')
        response = self.client.get(reverse('loc_detail:index'), {'search': 'Central Park'})
